...
public class RequestFullAdapter extends RecyclerView.Adapter<RequestFullAdapter.PostViewHolder> {
    private FirebaseFirestore mStore = FirebaseFirestore.getInstance();

    private List<Request> datas;
    private Context context_1;
    public RequestFullAdapter(List<Request> datas, Context mcontext) {
    ...
    @NonNull
    @Override
    public RequestFullAdapter.PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


        return new RequestFullAdapter.PostViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.request_question,parent,false));

    }

    @Override
    public void onBindViewHolder(@NonNull final RequestFullAdapter.PostViewHolder holder, int position) {
